...
import AddFilm from "./Text/AddText.js";
import FilmListPage from "./Text/TextListPage.js";
...
const Router = () => {
  ...
  window.addEventListener("load", (e) => {
    ...
    if (!componentToRender)
      return ErrorPage(
        new Error("The " + window.location.pathname + " resource does not exist.")
      );
    componentToRender();
  });
...
const RedirectUrl = (uri, data) => {
  ...
  if (routes[uri]) {
    ...
    ErrorPage(new Error("The " + uri + " resource does not exist"));
  }
};
